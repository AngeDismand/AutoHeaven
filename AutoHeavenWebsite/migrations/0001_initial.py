    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_de_naissance', models.DateField(default='1980-01-01', null=True, verbose_name='date de naissance')),
                ...
                ('role', models.CharField(choices=[('Empployé', 'Employé'), ('Client', 'Client'), ('SuperAdmin', 'SuperAdmin')], max_length=10)),
